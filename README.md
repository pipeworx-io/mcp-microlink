...
`tools/list` at `https://gateway.pipeworx.io/microlink/mcp` returns the tools in the table
...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/microlink_get_metadata \
  -H 'Content-Type: application/json' \
  -d '{"url":"https://www.example.com"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/microlink_get_metadata`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
